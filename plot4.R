plot4 <- function() {
        ...
        png(filename="plot4.png",
            width=480,height=480,units="px",pointsize=10,bg="white")
        ...
        axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"),las=1,cex.axis=1.1)
        ...
        ### Plot the data (3)
        plot(power$Voltage,type="l",xlab="",xaxt="n",ylab="Voltage",cex.lab=1.1)
        axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"),las=1,cex.axis=1.1)
